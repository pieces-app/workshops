...
import 'package:runtime_common_library/model/tag.dart' show Tag;
...
class SearchedTag {
  ...
  @override
  String toString() => 'SearchedTag[schema=$schema, tag=$tag, exact=$exact, similarity=$similarity, temporal=$temporal, identifier=$identifier]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, SearchedTag> map) {
