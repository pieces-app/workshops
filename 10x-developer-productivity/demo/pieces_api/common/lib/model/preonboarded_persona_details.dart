...
class PreonboardedPersonaDetails {
  ...
  @override
  String toString() => 'PreonboardedPersonaDetails[schema=$schema, languages=$languages, personas=$personas]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, PreonboardedPersonaDetails> map) {
