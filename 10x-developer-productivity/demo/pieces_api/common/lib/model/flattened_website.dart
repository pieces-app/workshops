...
class FlattenedWebsite {
  ...
  @override
  String toString() => 'FlattenedWebsite[schema=$schema, id=$id, assets=$assets, name=$name, url=$url, created=$created, updated=$updated, deleted=$deleted, mechanisms=$mechanisms, interactions=$interactions, persons=$persons, conversations=$conversations, score=$score, summaries=$summaries]';
