...
import 'package:runtime_common_library/model/qgpt_streamed_output_extracted_textual_materials.dart' show QGPTStreamedOutputExtractedTextualMaterials;
...
class QGPTStreamedOutputExtractedMaterials {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.textual != null) {
      _json[r'textual'] = textual?.toJson();
    }
    return _json;
  }
  ...
  static Map<String, dynamic> mapToJson(Map<String, QGPTStreamedOutputExtractedMaterials> map) {
