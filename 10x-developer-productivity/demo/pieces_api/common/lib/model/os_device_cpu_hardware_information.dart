...
class OSDeviceCPUHardwareInformation {
  ...
  @override
  String toString() => 'OSDeviceCPUHardwareInformation[schema=$schema, name=$name, memory=$memory]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, OSDeviceCPUHardwareInformation> map) {
