...
class FlattenedWorkstreamSummary {
  ...
  @override
  String toString() => 'FlattenedWorkstreamSummary[schema=$schema, id=$id, score=$score, created=$created, updated=$updated, events=$events, name=$name, annotations=$annotations, ranges=$ranges, model=$model, websites=$websites, anchors=$anchors, assets=$assets, conversations=$conversations, persons=$persons, applications=$applications]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, FlattenedWorkstreamSummary> map) {
