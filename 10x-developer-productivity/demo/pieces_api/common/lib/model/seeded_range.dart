...
import 'package:runtime_common_library/model/seeded_range_conversation_association.dart' show SeededRangeConversationAssociation;
...
class SeededRange {
  ...
  @override
  String toString() => 'SeededRange[schema=$schema, to=$to, from=$from, between=$between, summary=$summary, conversation=$conversation]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, SeededRange> map) {
