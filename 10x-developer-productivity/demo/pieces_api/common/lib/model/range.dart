...
class Range {
  ...
  @override
  String toString() => 'Range[schema=$schema, id=$id, score=$score, created=$created, updated=$updated, to=$to, from=$from, between=$between, summaries=$summaries, conversations=$conversations]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, Range> map) {
