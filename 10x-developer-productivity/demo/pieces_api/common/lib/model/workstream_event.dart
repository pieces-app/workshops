...
class WorkstreamEvent {
  ...
  @override
  String toString() => 'WorkstreamEvent[schema=$schema, id=$id, score=$score, application=$application, created=$created, updated=$updated, trigger=$trigger, context=$context, summaries=$summaries]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, WorkstreamEvent> map) {
