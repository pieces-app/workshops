...
import 'package:runtime_common_library/model/os_device_cpu_hardware_information.dart' show OSDeviceCPUHardwareInformation;
import 'package:runtime_common_library/model/os_device_gpu_hardware_information.dart' show OSDeviceGPUHardwareInformation;
...
class OSDeviceHardwareInformation {
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  OSDeviceCPUHardwareInformation? cpu;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  OSDeviceGPUHardwareInformation? gpu;
  ...
  @override
  String toString() => 'OSDeviceHardwareInformation[schema=$schema, cpu=$cpu, gpu=$gpu]';
  ...
  static OSDeviceHardwareInformation? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return OSDeviceHardwareInformation(
        ...
        cpu: OSDeviceCPUHardwareInformation.fromJson(json[r'cpu']),
        gpu: OSDeviceGPUHardwareInformation.fromJson(json[r'gpu']),
      );
    }
    return null;
  }
  ...
  static Map<String, dynamic> mapToJson(Map<String, OSDeviceHardwareInformation> map) {
