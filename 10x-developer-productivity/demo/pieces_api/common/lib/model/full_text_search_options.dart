...
class FullTextSearchOptions {
  ...
  @override
  String toString() => 'FullTextSearchOptions[schema=$schema, similarity=$similarity, exact=$exact]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, FullTextSearchOptions> map) {
