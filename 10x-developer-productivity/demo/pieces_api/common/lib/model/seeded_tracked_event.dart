...
class SeededTrackedEvent {
  ...
  @override
  String toString() => 'SeededTrackedEvent[asset=$asset, format=$format, interaction=$interaction, keyboard=$keyboard, session=$session, assets=$assets, ml=$ml, adoption=$adoption, conversation=$conversation]';
