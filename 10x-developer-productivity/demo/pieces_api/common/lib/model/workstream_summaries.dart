...
class WorkstreamSummaries {
  ...
  @override
  String toString() => 'WorkstreamSummaries[schema=$schema, iterable=$iterable, indices=$indices, score=$score]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, WorkstreamSummaries> map) {
