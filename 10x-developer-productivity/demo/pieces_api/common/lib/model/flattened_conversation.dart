...
class FlattenedConversation {
  ...
  @override
  String toString() => 'FlattenedConversation[schema=$schema, id=$id, name=$name, created=$created, updated=$updated, deleted=$deleted, favorited=$favorited, application=$application, annotations=$annotations, messages=$messages, model=$model, assets=$assets, websites=$websites, anchors=$anchors, type=$type, grounding=$grounding, score=$score, pipeline=$pipeline, demo=$demo, summaries=$summaries]';
