...
import 'package:runtime_common_library/model/classifications.dart' show Classifications;
...
class ProjectModule {
  ...
  @override
  String toString() => 'ProjectModule[schema=$schema, anchor=$anchor, range=$range, contributors=$contributors, classifications=$classifications]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.classifications != null) {
      _json[r'classifications'] = classifications?.toJson();
    }
    return _json;
  }
  ...
  static Map<String, dynamic> mapToJson(Map<String, ProjectModule> map) {
