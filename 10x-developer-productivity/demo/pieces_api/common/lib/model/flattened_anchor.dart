...
class FlattenedAnchor {
  ...
  @override
  String toString() => 'FlattenedAnchor[schema=$schema, id=$id, type=$type, watch=$watch, points=$points, created=$created, updated=$updated, deleted=$deleted, assets=$assets, name=$name, annotations=$annotations, conversations=$conversations, score=$score, summaries=$summaries]';
