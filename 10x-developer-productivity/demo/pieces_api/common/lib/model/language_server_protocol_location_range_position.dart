...
class LanguageServerProtocolLocationRangePosition {
  ...
  @override
  String toString() => 'LanguageServerProtocolLocationRangePosition[schema=$schema, line=$line, character=$character]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, LanguageServerProtocolLocationRangePosition> map) {
