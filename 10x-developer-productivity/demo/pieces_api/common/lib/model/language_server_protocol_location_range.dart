...
import 'package:runtime_common_library/model/language_server_protocol_location_range_position.dart' show LanguageServerProtocolLocationRangePosition;
...
class LanguageServerProtocolLocationRange {
  ...
  @override
  String toString() => 'LanguageServerProtocolLocationRange[schema=$schema, start=$start, end=$end]';
  ...
  Map<String, dynamic> toJson() {
    ...
    _json[r'start'] = start.toJson();
    _json[r'end'] = end.toJson();
    return _json;
  }
  ...
  static Map<String, dynamic> mapToJson(Map<String, LanguageServerProtocolLocationRange> map) {
